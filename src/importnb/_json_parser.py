...
class ParsingFrontend(Serialize):
    ...
    def _make_lexer_thread(
        ...
        return (
            text
            if self.skip_lexer
            else cls(self.lexer, None)
            if text is None
            else cls.from_text(self.lexer, text)
        )
...
DATA = {
    "parser": {
        ...
        "parser": {
            ...
            "states": {
                0: {0: (1, {"@": 15}), 1: (1, {"@": 15}), 2: (1, {"@": 15}), 3: (1, {"@": 15})},
                1: {3: (0, 33)},
                2: {3: (1, {"@": 25}), 2: (1, {"@": 25})},
                3: {2: (0, 13), 4: (0, 21), 3: (1, {"@": 27})},
                4: {1: (1, {"@": 30}), 2: (1, {"@": 30})},
                5: {0: (1, {"@": 20}), 1: (1, {"@": 20}), 2: (1, {"@": 20}), 3: (1, {"@": 20})},
                6: {3: (1, {"@": 31}), 2: (1, {"@": 31})},
                7: {0: (1, {"@": 16}), 1: (1, {"@": 16}), 2: (1, {"@": 16}), 3: (1, {"@": 16})},
                8: {2: (0, 24), 1: (0, 5)},
                9: {1: (1, {"@": 29}), 2: (1, {"@": 29})},
                10: {0: (1, {"@": 19}), 1: (1, {"@": 19}), 2: (1, {"@": 19}), 3: (1, {"@": 19})},
                11: {0: (1, {"@": 22}), 1: (1, {"@": 22}), 2: (1, {"@": 22}), 3: (1, {"@": 22})},
                12: {0: (1, {"@": 18}), 1: (1, {"@": 18}), 2: (1, {"@": 18}), 3: (1, {"@": 18})},
                13: {5: (0, 6), 6: (0, 27), 7: (0, 30)},
                14: {0: (1, {"@": 12})},
                15: {3: (0, 29), 6: (0, 27), 5: (0, 3), 8: (0, 1), 7: (0, 30)},
                16: {0: (1, {"@": 13}), 1: (1, {"@": 13}), 2: (1, {"@": 13}), 3: (1, {"@": 13})},
                17: {
                    9: (0, 22),
                    10: (0, 26),
                    11: (0, 15),
                ...
                25: {0: (1, {"@": 21}), 1: (1, {"@": 21}), 2: (1, {"@": 21}), 3: (1, {"@": 21})},
                26: {0: (1, {"@": 17}), 1: (1, {"@": 17}), 2: (1, {"@": 17}), 3: (1, {"@": 17})},
                27: {20: (0, 32)},
                28: {0: (1, {"@": 14}), 1: (1, {"@": 14}), 2: (1, {"@": 14}), 3: (1, {"@": 14})},
                29: {0: (1, {"@": 24}), 1: (1, {"@": 24}), 2: (1, {"@": 24}), 3: (1, {"@": 24})},
                30: {
                    20: (1, {"@": 28}),
                    0: (1, {"@": 28}),
                    1: (1, {"@": 28}),
                ...
                33: {0: (1, {"@": 23}), 1: (1, {"@": 23}), 2: (1, {"@": 23}), 3: (1, {"@": 23})},
            },
            "start_states": {"start": 17},
            "end_states": {"start": 19},
        },
...
MEMO = {
    ...
    25: {
        "origin": {"name": "item", "__type__": "NonTerminal"},
        "expansion": [
    ...
    26: {
        "origin": {"name": "_items", "__type__": "NonTerminal"},
        "expansion": [
